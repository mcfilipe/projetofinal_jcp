...
def gerar_arte(numero, paleta, simetria=False):
    ...
    canvas.postscript(file="arte_abstrata.eps")
    turtle.done()
...
simetria = simpledialog.askstring("Modo", "Queres modo simétrico? (s/n)").lower().startswith("s")

paleta = escolher_paleta()
gerar_arte(quantidade, paleta, simetria)
